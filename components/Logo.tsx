export default function Logo({ className = "" }: { className?: string }) {
  return (
    <div className={`flex items-center gap-2 ${className}`}>
      ...
      {/* Teks Logo ditambah whitespace-nowrap agar tidak terpotong di HP */}
      <span className="text-2xl font-serif font-bold tracking-tight text-brand-brown whitespace-nowrap">
