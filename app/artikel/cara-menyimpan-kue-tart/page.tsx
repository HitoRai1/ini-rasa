...
export const metadata: Metadata = {
  title: "Cara Menyimpan Kue Tart Agar Tetap Lembut Berhari-hari | Ini Rasa",
  description: "Kunci utamanya ada pada cara penyimpanan yang tepat agar kelembapannya terjaga. Jangan asal masuk kulkas!",
  openGraph: {
    title: "Cara Menyimpan Kue Tart Agar Tetap Lembut Berhari-hari",
    description: "Pernahkah kamu membeli kue tart yang lezat, namun teksturnya menjadi keras dan kering setelah disimpan di kulkas? Temukan cara yang benar di sini.",
    images: [
      {
        url: "https://dwxnfjbdbvulzpzenffk.supabase.co/storage/v1/object/public/ini-rasa/Strawberry%20Shortcake.webp",
        width: 1200,
        height: 630,
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 mt-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="lg:col-span-1">
            <ArtikelSidebar currentLink="/artikel/cara-menyimpan-kue-tart" />
          </div>
        </div>
      </section>
