...
import Link from "next/link"; // Tambahan baru untuk link
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-brand-brown/70 max-w-2xl mx-auto">
            Pilih sajian favoritmu. Mulai dari kue premium hingga hampers eksklusif.
          </p>
        </div>
          ...
          {products?.map((product, index) => {
            ...
            return (
              <div key={product.id} className="bg-white rounded-2xl overflow-hidden shadow-sm border border-brand-sand/30 hover:shadow-md transition group flex flex-col">
                ...
                {/* Gambar Dibungkus Link agar bisa di-klik */}
                <Link href={`/menu/${product.id}`} className="aspect-square bg-brand-sand/20 relative flex items-center justify-center overflow-hidden">
                ...
                <div className="p-5 flex flex-col flex-grow">
                  ...
                  {/* Judul Dibungkus Link agar bisa di-klik */}
